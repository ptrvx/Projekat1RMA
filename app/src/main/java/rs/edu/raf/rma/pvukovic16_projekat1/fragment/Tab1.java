...
public class Tab1 extends Fragment {
    ...
    public View onCreateView(
        ...
        EditText editText = root.findViewById(R.id.t1_et_name);
        ...
        arrayAdapter = new ArrayAdapter<>(container.getContext(), android.R.layout.simple_spinner_item, categoryList);
